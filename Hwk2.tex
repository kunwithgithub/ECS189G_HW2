...
or leniently usernum rates their movies. Basically, which feature contributes to the `personality`
factor.


Intuitively, occupation can also represent personality. For example, a retired person tends to rate
movies higher than other occupations, which is likely due to the age. Since age likely affects
