...
\subsubsection{Ex-model1(Age$*$occ)}
\begin{verbatim}
Call:
...
\subsubsection{Ex-model2(Age$*$Gender)}
\begin{verbatim}
Call:
...
\subsubsection{Ex-model3(movienum+usernum+genre+age$*$occ)}
\begin{verbatim}
    Call:
...
\subsubsection{Ex-model4(movienum+usernum+genre+age$*$occ(filtered))}
\begin{verbatim}
...
\subsubsection{Ex-model5(movienum+usernum+gender$*$occ)}
\begin{verbatim}
Call:
...
\subsubsection{Ex-model6(movienum+usernum+gender$*$genre)}
\begin{verbatim}
    Call:
...
\subsubsection{Ex-model7(movienum+usernum+age$*$genre)}
\begin{verbatim}
    Call:
...
\subsubsection{Ex-model8(movienum+usernum+age*occ+gender*genre)}
\begin{verbatim}
Call:
...
\subsubsection{Ex-model9(movienum+usernum+age*genre+gender*occ)}
\begin{verbatim}
Call:
lm(formula = ttt, data = u.big.trn)
Coefficients:
...
\subsubsection{Ex-model10(movienum+usernum+age*genre+gender*occ(filtered))}
\begin{verbatim}
Call:
...
\subsubsection{Ex-model11(movienum+usernum+genre+age*transID)}
...
\subsubsection{Ex-model12(movienum+usernum+age+gender+ZIP+genre)}
